...
public class TestTest {
    ...
    public static void main(String[] args) {
        ...
        final String SINGLE_FACE_URL = "https://wx3.sinaimg.cn/large/0067q3Kily4gxtcmpc6j0j30dn098dmz.jpg";
        ...
        final String  GROUP_FACES_URL = "https://wx3.sinaimg.cn/large/0067q3Kily4gxtcmpc6j0j30dn098dmz.jpg";
        ...
        final AzureRegions REGION = AzureRegions.AUSTRALIAEAST;
        // Create Face client
    ...
    public static List<UUID> detectFaces(FaceAPI client, String imageURL, String imageName) {
        List<FaceAttributeType> att = new ArrayList<>();
        att.add(FaceAttributeType.EMOTION);
        // Create face IDs list
        List<DetectedFace> facesList = client.faces().detectWithUrl(imageURL,
                new DetectWithUrlOptionalParameter().withReturnFaceId(true));
